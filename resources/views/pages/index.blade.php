                ...
                <div class="col-md-3">
                    <div class="card product-card w-100 h-100">
                        <div class="product-image position-relative">
                            <a href="" class="product-img d-block">
                                <img style="width:260px; height:260px" class="img-fixed-size" src="{{ asset($product->img) }}" alt="">
                            </a>
                            ...
                            <div class="product-action">
                                ...
                                <a href="{{route('cart.add', $product->id)}}" class="btn btn-dark">
                                    <i class="fa fa-shopping-cart"></i> Add To Cart
                                </a>
                            </div>
                        </div>
                        <div class="card-body text-center mt-3">
                            <a class="h6 link" href="{{route('product_detail',$product->id)}}">{{$product->name}}</a>
