									...
									<div class="row">
											<div class="col-md-6">
												<div class="mb-3">
													...
													<input type="text" name="name" value="{{$brands->name}}" id="name" class="form-control" placeholder="Name">	
												</div>
											</div>
											<div class="col-md-6">
												<div class="mb-3">
													<label for="email">Slug</label>
													<input type="text" name="slug" value="{{$brands->slug}}" id="slug" class="form-control" placeholder="Slug">	
												</div>
											</div>				
										</div>
									</div>							
